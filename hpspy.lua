...
-- Daily seed
local _d = os.date("!*t")
local _seed = _d.year * 10000 + _d.month * 100 + _d.day

-- Key derivation
local _SA, _SB, _SC = 3383210961, 1328450565, 1907794834
local _uid = player.UserId
local _a = (_uid * _SA + _seed * 1013904223 + 1013904223) % 4294967296
local _b = (_uid * _SB + _seed * _SC) % 4294967296
local _c = (_a ~ _b ~ (_uid % 65535) ~ _seed) % 4294967296
local _expected = string.format("hpspy-%08x-%08x", _a, _c)
...
card.Size = UDim2.new(0,340,0,270)
card.Position = UDim2.new(0.5,-170,0.5,-135)
...
-- Step 1
local s1 = Instance.new("TextLabel", card)
s1.Text = "Step 1 — Copy this link, open in browser, complete tasks:"
s1.Size = UDim2.new(1,-20,0,14)
s1.Position = UDim2.new(0,10,0,48)
s1.BackgroundTransparency = 1
s1.TextColor3 = Color3.fromRGB(160,160,180)
s1.TextSize = 10
s1.Font = Enum.Font.Gotham
s1.TextXAlignment = Enum.TextXAlignment.Left

-- Link display box (TextBox, not editable, user long-presses to copy)
local linkDisplay = Instance.new("TextBox", card)
linkDisplay.Text = "https://loot-link.com/s?dWlydiWs"
linkDisplay.Size = UDim2.new(1,-20,0,32)
linkDisplay.Position = UDim2.new(0,10,0,64)
linkDisplay.BackgroundColor3 = Color3.fromRGB(20,20,30)
linkDisplay.TextColor3 = Color3.fromRGB(255,200,50)
linkDisplay.TextSize = 10
linkDisplay.Font = Enum.Font.Code
linkDisplay.BorderSizePixel = 0
linkDisplay.TextEditable = false
linkDisplay.ClearTextOnFocus = false
linkDisplay.TextXAlignment = Enum.TextXAlignment.Center
Instance.new("UICorner", linkDisplay).CornerRadius = UDim.new(0,6)

-- Step 2
local s2 = Instance.new("TextLabel", card)
s2.Text = "Step 2 — After tasks, enter your Roblox User ID on the page to get key:"
s2.Size = UDim2.new(1,-20,0,26)
s2.Position = UDim2.new(0,10,0,102)
s2.BackgroundTransparency = 1
s2.TextColor3 = Color3.fromRGB(160,160,180)
s2.TextSize = 10
...
-- Step 3
local s3 = Instance.new("TextLabel", card)
s3.Text = "Step 3 — Paste your key below and click Verify:"
s3.Size = UDim2.new(1,-20,0,14)
s3.Position = UDim2.new(0,10,0,130)
s3.BackgroundTransparency = 1
s3.TextColor3 = Color3.fromRGB(160,160,180)
s3.TextSize = 10
...
keyInput.PlaceholderText = "hpspy-xxxxxxxx-xxxxxxxx"
keyInput.Text = ""
keyInput.Size = UDim2.new(1,-20,0,34)
keyInput.Position = UDim2.new(0,10,0,146)
keyInput.BackgroundColor3 = Color3.fromRGB(22,22,32)
keyInput.TextColor3 = Color3.fromRGB(255,255,255)
keyInput.PlaceholderColor3 = Color3.fromRGB(60,60,80)
...
verifyBtn.Size = UDim2.new(1,-20,0,36)
verifyBtn.Position = UDim2.new(0,10,0,190)
verifyBtn.BackgroundColor3 = Color3.fromRGB(0,190,80)
...
status.Text = "Key resets daily at UTC midnight — unique to your account"
status.Size = UDim2.new(1,0,0,16)
status.Position = UDim2.new(0,0,0,234)
status.BackgroundTransparency = 1
status.TextColor3 = Color3.fromRGB(55,55,70)
status.TextSize = 10
...
credit.Position = UDim2.new(0,0,0,252)
credit.BackgroundTransparency = 1
credit.TextColor3 = Color3.fromRGB(38,38,52)
credit.TextSize = 10
credit.Font = Enum.Font.Gotham
credit.TextXAlignment = Enum.TextXAlignment.Center

-- Verify logic — no loops, no executor APIs
verifyBtn.MouseButton1Click:Connect(function()
    local inp = keyInput.Text:gsub("%s+", "")
    if inp == "" then
    ...
    if inp == _expected then
        ...
        status.TextColor3 = Color3.fromRGB(0,200,80)
        verifyBtn.Text = "Launching..."
        verifyBtn.BackgroundColor3 = Color3.fromRGB(0,150,60)
        task.delay(1, function()
            sg:Destroy()
            _launch()
        end)
    else
        status.Text = "Wrong key — make sure you used YOUR User ID on the page"
        status.TextColor3 = Color3.fromRGB(255,70,70)
    end
end)
